import { ChevronUp, ChevronDown, X, Settings, ChevronLeft, ChevronRight } from 'lucide-react';
...
export function DataTable<T extends Record<string, unknown>>({
    ...
    return (
        <div className="datatable-container">
            {/* Header Section */}
            <div className="datatable-header flex items-center gap-4">
                <div className="datatable-header-left flex items-center gap-2">
                    {/* Search */}
                    <div className="datatable-search-wrapper flex items-center">
                    ...
                    {/* Filters */}
                    {filters.length > 0 && (
                        <div className="datatable-filters flex items-center">
                            {filters.map((filter) => (
                                <div key={filter.key} className="datatable-filter-item flex items-center gap-1">
                                    <Select
                ...
                {/* Per Page */}
                <div className="datatable-perpage flex items-center gap-2">
            ...
            {/* Footer */}
            <div className="datatable-footer flex items-center justify-between">
                ...
                <div className="datatable-pagination flex items-center gap-2">
                    <Button
